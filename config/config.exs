...
config :koombea_web_scraper,
  ecto_repos: [KoombeaWebScraper.Repo],
...
config :koombea_web_scraper, KoombeaWebScraperWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: KoombeaWebScraperWeb.ErrorHTML, json: KoombeaWebScraperWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: KoombeaWebScraper.PubSub,
  live_view: [signing_salt: "5cztK6MW"]
...
config :koombea_web_scraper, KoombeaWebScraper.Mailer, adapter: Swoosh.Adapters.Local
